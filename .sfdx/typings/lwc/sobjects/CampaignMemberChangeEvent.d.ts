...
declare module "@salesforce/schema/CampaignMemberChangeEvent.mcdm_15__JourneyApprovalState__c" {
  const mcdm_15__JourneyApprovalState__c:string;
  export default mcdm_15__JourneyApprovalState__c;
}
