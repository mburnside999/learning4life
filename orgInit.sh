sfdx force:org:delete -u L4LscratchMOREJUNK
sfdx shane:org:create --verbose --userprefix=mike --userdomain=l4ldemo.com -f config/project-scratch-def.json -d 30 -s -a L4LscratchMOREJUNK
