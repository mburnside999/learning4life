    ...
    * */
    ...
    function tmpl$1i($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        props: {
          "title": "Mark Session Objectives in Bulk - V0.1.2 [Prototype]"
        },
        key: 2
      }, [api_element("br", {
        key: 3
        ...
        key: 6,
        on: {
          "click": _m0 || ($ctx._m0 = api_bind($cmp.handleClickCorrect))
        }
      }, []), api_custom_element("lightning-button", _lightningButton, {
        props: {
          "variant": "neutral",
        ...
        key: 7,
        on: {
          "click": _m1 || ($ctx._m1 = api_bind($cmp.handleClickIncorrect))
        }
      }, []), api_custom_element("lightning-button", _lightningButton, {
        props: {
          "variant": "neutral",
        ...
        key: 8,
        on: {
          "click": _m2 || ($ctx._m2 = api_bind($cmp.handleClickPrompted))
        }
      }, []), api_custom_element("lightning-button", _lightningButton, {
        props: {
          "variant": "neutral",
        ...
        key: 9,
        on: {
          "click": _m3 || ($ctx._m3 = api_bind($cmp.handleClickPromptedArray))
        }
      }, []), api_custom_element("lightning-button", _lightningButton, {
        props: {
          "variant": "destructive",
    ...
    class Lwcsessionobjective extends lwc.LightningElement {
      ...
      handleClickPromptedArray(event) {
        console.log('ZZZZZZZZZZZ ' + JSON.stringify(event.target));
