    ...
    * */
    ...
    class Lwcsessionobjective extends lwc.LightningElement {
      ...
      handleSearchKeyInput(event) {
        ...
        this.allObjectives = this.sessionObjectives.filter(so => so.Program__c.toLowerCase().includes(searchKey) || so.Objective_Name__c.toLowerCase().includes(searchKey));
        this.sessionObjectives = this.allObjectives;
      }
