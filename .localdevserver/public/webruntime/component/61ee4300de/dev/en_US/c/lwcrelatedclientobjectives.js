    ...
    * */
    ...
    class lwcrelatedclientobjectives extends lwc.LightningElement {
      ...
      handleSearchKeyInput(event) {
        ...
        this.clientobjectives = this.allObjectives.filter(so => so.Name.toLowerCase().includes(searchKey) || so.Objective_Name__c.toLowerCase().includes(searchKey) || so.Status__c.toLowerCase().includes(searchKey));
