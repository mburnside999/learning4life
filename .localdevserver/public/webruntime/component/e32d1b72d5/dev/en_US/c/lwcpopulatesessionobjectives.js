    ...
    * */
    ...
    class Lwcpopulatesessionobjectives extends lwc.LightningElement {
      ...
      handleClickArray(event) {
        if (this.selectedRows) {
          ...
          apexInvoker$1({
            ...
            console.log('Refreshing');
            this.objectives = this.allObjetives;
            return lds.refresh(this.objectives);
          }).then(() => {
      ...
      handleSearchKeyInput(event) {
        ...
        this.objectives = this.allObjectives.filter(so => so.Name.toLowerCase().includes(searchKey) || so.Program__c.toLowerCase().includes(searchKey));
      }
