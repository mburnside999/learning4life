    ...
    * */
    ...
    class Lwcsessionobjective extends lwc.LightningElement {
      constructor(...args) {
        ...
        this.pageRef = void 0;
        this.draftValues = [];
        this.allObjectives = thid.sessionObjectives;
      }
      ...
      handleSearchKeyInput(event) {
        ...
        this.sessionObjectives = this.allObjectives.filter(so => so.Program_Name__c.toLowerCase().includes(searchKey) || so.SD_Name__c.toLowerCase().includes(searchKey) || so.Objective_Name__c.toLowerCase().includes(searchKey));
      }
