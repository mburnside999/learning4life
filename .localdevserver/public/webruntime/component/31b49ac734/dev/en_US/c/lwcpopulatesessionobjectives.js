    ...
    * */
    ...
    function tmpl$1i($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 6,
        on: {
          "click": _m0 || ($ctx._m0 = api_bind($cmp.handleClickCreate))
        }
      }, []), api_custom_element("lightning-button", _lightningButton, {
        props: {
          "label": "Cancel",
    ...
    const apexInvoker$1 = lds.getApexInvoker("", "MBSessionObjectives", "createSessionObjectives", false);
    wireService.register(apexInvoker$1, lds.generateGetApexWireAdapter("", "MBSessionObjectives", "createSessionObjectives", false));
