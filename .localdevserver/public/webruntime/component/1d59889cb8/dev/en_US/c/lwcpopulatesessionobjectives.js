    ...
    * */
    ...
    function tmpl$1i($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 8
      }, []), api_text("DEBUG: Heres a list of candidate Objectives. Select one or more for creation of Session Objectives. The DELETE ALL bad boy doesn't care what you select. Toast confirmation coming."), api_custom_element("lightning-datatable", _lightningDatatable, {
        props: {
          "keyField": "Id",
