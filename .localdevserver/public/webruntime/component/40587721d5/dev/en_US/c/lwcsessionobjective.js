    ...
    * */
    ...
    function tmpl$1i($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 10
      }, []), api_text("DEBUG: These are the current Session Objectives. Select one or more and press Correct, Incorrect, Prompted. Toast confirmation coming."), api_custom_element("lightning-datatable", _lightningDatatable, {
        props: {
          "keyField": "Id",
