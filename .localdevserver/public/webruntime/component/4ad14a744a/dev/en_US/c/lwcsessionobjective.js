    ...
    * */
    ...
    function tmpl$1i($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 10
      }, []), api_text("DEBUG: These are the current Session Objectives. Select one or more and press Correct, Incorrect, Prompted.  The DELETE ALL bad boy doesn't care what you select. Toast confirmation coming."), api_custom_element("lightning-datatable", _lightningDatatable, {
        props: {
          "keyField": "Id",
      ...
      }, [])]), api_text("DEBUG: Looks like we're done Listing objectives.")];
    }
