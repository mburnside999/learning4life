    ...
    * */
    ...
    class lwcrelatedclientobjectives extends lwc.LightningElement {
      ...
      handleSearchKeyInput(event) {
        ...
        this.clientobjectives = this.allObjectives.filter(so => so.Name.toLowerCase().includes(searchKey) || so.Program__c.toLowerCase().includes(searchKey) || so.SD_Name__c.toLowerCase().includes(searchKey));
