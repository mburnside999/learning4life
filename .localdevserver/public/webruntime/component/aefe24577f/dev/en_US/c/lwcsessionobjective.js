    ...
    * */
    ...
    function tmpl$1i($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        props: {
          "title": "Mike's Prototype - Session Objective Mass Updater"
        },
        key: 2
      }, [api_element("br", {
        key: 3
        ...
        key: 9
      }, []), api_text("DEBUG: Heres a list of related objectives..."), api_custom_element("lightning-datatable", _lightningDatatable, {
        props: {
          "keyField": "Id",
    ...
    class Lwcsessionobjective extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.recordId = 'a3M2v00000192cAEAQ';
      ...
      handleClickCorrect(event) {
        console.log(JSON.stringify(this.sessionObjectives.data));
