    ...
    * */
    ...
    function tmpl$1i($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        props: {
          "title": "Create Session Objectives in Bulk - V0.1.3 [Prototype]"
        },
        key: 2
      }, [api_element("input", {
        attrs: {
        ...
        key: 9
      }, []), api_text("DEBUG: Heres a list of candidate Objectives. Select one or more for creation of Session Objectives. Session record page refresh currently required to see results. Now with Live filtering across Name,Program and SD."), api_custom_element("lightning-datatable", _lightningDatatable, {
        props: {
          "keyField": "Id",
          "data": $cmp.objectives,
          "columns": $cmp.columns
      ...
      handleClickArray(event) {
        if (this.selectedRows) {
          ...
          apexInvoker$1({
            ...
            console.log('Refreshing'); //return refreshApex(this.objectives);
          }).then(() => {
