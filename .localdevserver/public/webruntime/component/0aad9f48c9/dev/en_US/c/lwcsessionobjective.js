    ...
    * */
    ...
    class Lwcsessionobjective extends lwc.LightningElement {
      ...
      wiredSO({
        ...
        if (data) {
          this.sessionObjectives.data = data;
          this.error = undefined;
        } else if (error) {
          this.error = error;
          this.sessionObjectives.data = undefined;
        }
      }
      ...
      handleSearchKeyInput(event) {//const searchKey = event.target.value.toLowerCase();
        //this.sessionObjectives.data = this.sessionObjectives.data.filter(
        //so => so.Program__c.toLowerCase().includes(searchKey) || so.Objective_Name__c.toLowerCase().includes(searchKey)
        // );
      }
