    ...
    * */
    ...
    function tmpl$1i($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        props: {
          "title": "Mike's Prototype V0.1 -  Objective Mass Creator"
        },
        key: 2
      }, [api_element("br", {
        key: 3
        ...
        props: {
          "variant": "success",
          "label": "Create Session Objectives",
          "title": "Test Correct"
        },
        key: 6,
        on: {
        ...
        key: 8
      }, []), api_text("DEBUG: Heres a list of candidate objectives..."), api_custom_element("lightning-datatable", _lightningDatatable, {
        props: {
          "keyField": "Id",
      ...
      }, [])]), api_text("DEBUG: Looks like we're done Listing candidate objectives.")];
    }
      ...
      handleClickCreate(event) {
        if (this.selectedRows) {
          for (let i = 0; i < this.selectedRows.length; i++) {
            ...
            console.log('Commencing imperative Call to sessionObjectivesCreate(objective) ');
            apexInvoker$1({
