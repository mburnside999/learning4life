    ...
    * */
    ...
    class Lwcsessionobjective extends lwc.LightningElement {
      ...
      handleSearchKeyInput(event) {
        ...
        this.sessionObjectives = this.allObjectives.filter(so => so.Program__c.toLowerCase().includes(searchKey) || so.Objective_Name__c.toLowerCase().includes(searchKey) || so.SD__c.toLowerCase().includes(searchKey) || so.Comment__c.toLowerCase().includes(searchKey) || so.Previous_Status__c.toLowerCase().includes(searchKey));
      }
