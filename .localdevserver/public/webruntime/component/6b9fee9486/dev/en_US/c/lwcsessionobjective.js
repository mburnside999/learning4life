    ...
    * */
    ...
    class Lwcsessionobjective extends lwc.LightningElement {
      constructor(...args) {
        ...
        this.pageRef = void 0;
        this.draftValues = [];
        this.allObjectives = this.sessionObjectives.data;
        this.test = {};
      }
      ...
      handleSearchKeyInput(event) {
        ...
        this.sessionObjectives.data = this.allObjectives.filter(so => so.Program__c.toLowerCase().includes(searchKey) || so.Objective_Name__c.toLowerCase().includes(searchKey));
      }
