Webruntime.moduleRegistry.define('c/lwcrelatedclientobjectives', ['lwc', 'lightning/configProvider', 'force/lds', 'wire-service', 'lightning/navigation'], function (lwc, configProvider, lds, wireService, navigation) { 'use strict';
    ...
    * */
    ...
    function tmpl$1h($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        props: {
          "title": "Display Client Objectives - V0.0.1",
