    ...
    * */
    ...
    function tmpl$1i($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 9,
        on: {
          "click": _m3 || ($ctx._m3 = api_bind($cmp.handleClickDelete))
        }
      }, [])]), api_element("br", {
        key: 10
        ...
        key: 11,
        on: {
          "rowselection": _m4 || ($ctx._m4 = api_bind($cmp.getSelectedName))
        }
    ...
    const apexInvoker$2 = lds.getApexInvoker("", "MBSessionObjectives", "setSessionObjectivesArray", false);
    wireService.register(apexInvoker$2, lds.generateGetApexWireAdapter("", "MBSessionObjectives", "setSessionObjectivesArray", false));
    ...
    class Lwcsessionobjective extends lwc.LightningElement {
      ...
      handleClickPromptedArray(event) {
        if (this.selectedRows) {
          //alert("BUTTON PRESS  You selected: " + this.selectedRows[i].Id+' '+this.selectedRows[i].Name);  
          console.log('Commencing imperative Call to setSessionObjectivesCorrectArray(key) ');
          apexInvoker$1({
