Webruntime.moduleRegistry.define('c/lwcrelatedclientobjectives', ['lwc', 'lightning/configProvider', 'force/lds', 'wire-service'], function (lwc, configProvider, lds, wireService) { 'use strict';
    ...
    * */
    ...
    class lwcrelatedclientobjectives extends lwc.LightningElement {
      ...
      handleClick(event) {
        ...
        lds.refresh(this.clientobjectives);
      }
