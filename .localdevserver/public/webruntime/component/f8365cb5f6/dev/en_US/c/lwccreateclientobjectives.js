Webruntime.moduleRegistry.define('c/lwccreateclientobjectives', ['lwc', 'lightning/configProvider', 'force/lds', 'wire-service'], function (lwc, configProvider, lds, wireService) { 'use strict';
    ...
    * */
    ...
    function tmpl$1i($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        props: {
          "title": "Create Client Objectives - V0.1.0 "
        },
        key: 2
      }, [api_element("input", {
        attrs: {
        ...
        props: {
          "variant": "success",
          "label": "Create Client Objectives",
          "title": "Test Correct"
        },
        key: 7,
        on: {
    ...
    const apexInvoker = lds.getApexInvoker("", "MBSessionObjectives", "getUnusedObjectives", false);
    wireService.register(apexInvoker, lds.generateGetApexWireAdapter("", "MBSessionObjectives", "getUnusedObjectives", false));
    ...
    class Lwccreateclientobjectives extends lwc.LightningElement {
      ...
      connectedCallback() {
        console.log('starting, getting objectives, recordId = ' + recordId);
        apexInvoker({
          sess: '$recordId'
        }).then(result => {
      ...
      handleClickArray(event) {
        if (this.selectedRows) {
          ...
          }).finally(() => {//console.log('attempting to refresh client record');
