    ...
    * */
    ...
    function tmpl$1i($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        props: {
          "title": "Mark Session Objectives in Bulk - V0.1.5 [Prototype]"
        },
        key: 2
      }, [api_element("br", {
        key: 3
        ...
        key: 8
      }, []), api_text("DEBUG: Added Delete selected"), api_element("br", {
        key: 9
        ...
        key: 16
      }, []), api_text("DEBUG: These are the current Session Objectives. Select one or more and press Correct, Incorrect, Prompted.  The DELETE ALL bad boy doesn't care what you select."), api_custom_element("lightning-datatable", _lightningDatatable, {
        props: {
          "keyField": "Id",
